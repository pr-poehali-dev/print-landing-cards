          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div className="space-y-6 animate-fade-in">
              ...
              <div className="flex gap-8 pt-4">
                ...
                <div>
                  ...
                  <div className="text-sm text-muted-foreground">Срок печати</div>
                </div>
                <div>
            ...
            <div className="relative">
              ...
              <div className="relative grid grid-cols-2 gap-4">
                ...
                <Card className="overflow-hidden transform hover:scale-105 transition-transform duration-300 animate-scale-in mt-8">
                  <img 
        ...
        <div className="container mx-auto">
          <Card className="overflow-hidden">
            <div className="grid md:grid-cols-2">
              <div className="p-12 bg-gradient-to-br from-primary to-secondary text-white space-y-6">
                ...
                <div className="space-y-4">
                  ...
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      ...
                      <div className="font-bold text-lg">info@printmaster.ru</div>
                    </div>
                  </div>
                  <div className="flex items-center gap-3">
                    <div className="w-12 h-12 rounded-lg bg-white/20 flex items-center justify-center">
                    ...
                    <div>
                      ...
                      <div className="font-bold text-lg">Москва, ул. Примерная, 123</div>
                    </div>
                  </div>
                </div>
              </div>
              <div className="p-12 space-y-6">
                <h3 className="text-2xl font-bold">Отправьте заявку</h3>
                <div className="space-y-4">
                  <div>
